...
> [!WARNING]
> fad-checker is new and may still contain ( rare ) bugs. **double-check anything critical**, and please [report issues](https://github.com/9pings/fad-checker/issues); they get fixed fast.
