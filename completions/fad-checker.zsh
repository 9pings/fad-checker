...
_fad_check() {
	...
	opts=(
		...
		'(-r --report)'{-r,--report}'[outputs to write: html,doc,sbom,csaf,json,sarif]:list:'
		'(-o --report-output)'{-o,--report-output}'[report output directory]:dir:_files -/'
		'--help-all[every option, including the folded ones]'
