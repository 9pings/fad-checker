...
function renderCharts(payload = {}, opts = {}) {
	...
	const card3 = multiModule
		? (components.length
			? chartCard({ id: "chart-components", title: "Most vulnerable components", interactive, ...donutChart({ slices: components, width: W }) })
			: emptyCard("chart-components", "Most vulnerable components", "No critical or high production CVE."))
		: (scope.length
