...
module.exports = {
	...
	collect(app, ctx) {
		...
		return { components, coverage: [
			...
			{ applicationId: app.id, capability: "advisories", execution: "not-run", result: "indeterminate",
				sourceId: "application-advisories", expected: components.length, executed: 0,
