...
const SOURCE_DEFS = [
	...
	{ id: "packagistAudit", label: "Packagist security advisories", rel: "packagist-advisories", kind: "dir", flag: "packagistAudit" },
...
function runConfiguration(options = {}) {
	return {
		...
		packagistAudit: options.packagistAudit !== false,
